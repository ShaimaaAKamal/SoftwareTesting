...
public class Settings_Page extends BaseTest {
    WebDriver driver;
    // Logging Into Admin //

    By AdminUsernameField = By.xpath("//input[@id='input-username']");
    By AdminPasswordField = By.xpath("//input[@id='input-password']");
    ...
    By Localization_Selecting = By.xpath("//a[normalize-space()='Localisation']");
    By Store_Location_Selecting = By.xpath("//a[normalize-space()='Store Location']");

    // Adding New Store Information //
    By Store_Add_new_Icon_Selecting = By.xpath("//a[@aria-label='Add New']");
    ...
    By Store_SaveButton = By.xpath("//button[@aria-label='Save']");
    By Store_BackButton = By.xpath("//a[@aria-label='Back']");
    By Store_EditButton = By.xpath("//a[@aria-label='Edit']//i[@class='fa-solid fa-pencil']");
    ...
    By Language_Save_Button = By.xpath("//button[@aria-label='Save']");
    By Language_Back_Button = By.xpath("//a[@aria-label='Back']");
    By Language_Edit_Button = By.xpath("//a[@aria-label='Edit']");

    // Navigating to System/Localisation/Currency //
    By Currencies_selectionTab = By.xpath("//li[@class='active']//a[contains(text(),'Currencies')]");

    // Adding New Currency //
    By Currency_Add_new_Button = By.xpath("//a[@aria-label='Add New']");
    By Currency_Refresh_Button = By.xpath("//i[@class='fa-solid fa-rotate']");
    By Currency_Delete_Button = By.xpath("//button[@aria-label='Delete']");
    ...
    By StockStatus_selectionTab = By.xpath("//li[@class='active']//a[contains(text(),'Stock Statuses')]");

    // Adding new Stock Status //
    By Stock_Add_new_Button = By.xpath("//a[@aria-label='Add New']");
    By Stock_Delete_Button = By.xpath("//button[@aria-label='Delete']");
    ...
    By GroupUser_SelectionTab = By.xpath("//li[@class='active']//a[contains(text(),'User Groups')]");

    // Adding New User_Group //
    By GroupUser_Add_Button = By.xpath("//a[@aria-label='Add New']");
    ...
    By GroupUser_Save_Button = By.xpath("//button[@aria-label='Save']");
    By Group_Back_Button = By.xpath("//a[@aria-label='Back']");

    // Navigating To System/Users/API //
    By API_SelectionTab = By.xpath("//a[normalize-space()='API']");
    ...
    By API_Save_Button = By.xpath("//button[@aria-label='Save']");
    ...
    public void LoggingIntoAdmin (String Username, String Password) {
        driver.findElement(AdminUsernameField).sendKeys(Username);
    ...
    public void Language_Editing (String Name, Integer Code, String Locale,String Extension){
        ...
        driver.findElement(Language_Extension_Field).clear();
        driver.findElement(Language_Extension_Field).sendKeys(Extension);
    ...
    public void Stock_Adding (String Name1, String Name2){
    ...
    public void Stock_Editing (String Name1, String Name2) {
    ...
    public void User_Adding (String UserName, String FirstName, String LastName,String Email, String Password, String Confirmation){
        ...
        driver.findElement(User_Username_Field).sendKeys(LastName);
